...
const FlowDiagram = () => {
  ...
  const stepExamples = {
    0: (
      <div className="rounded-lg p-2 sm:p-4 flex flex-col items-center">
    ...
    2: (
      <div className="rounded-lg p-2 sm:p-4 space-y-3 flex flex-col">
        {[
    ...
    6: (
      <div className="rounded-lg p-2 sm:p-4 space-y-3 flex flex-col items-center">
        {[
